<div class="modal-dialog modal-md modal-right">
    <div class="modal-content">
        ...
        <div class="modal-body" style="height: 691px;">
            ...
            <form class="form-horizontal modal-body" id="leadsourceform" method="POST" action="{{ route('leadsource.save') }}" autocomplete="off">
                @csrf
                <input type="hidden" name="id" value="{{ $id ?? '' }}">
                <div class="row mb-3">
                    <label for="source" class="col-4 col-form-label">Source <span class="text-danger">*</span></label>
                    <div class="col-8">
