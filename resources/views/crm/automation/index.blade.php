        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">WorkFlow Automation</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
...
@section('add_on_script')
    ...
    <script>
        $(document).ready(function() {
            ...
            const roletable = $('#automation-datatable').DataTable({

                "processing": true,
                "serverSide": true,
                "ajax": {
                    "url": "<?= route('automation.list', $companyCode) ?>",
                    "dataType": "json",
                    "type": "POST",
                    "data": {
                        "_token": "<?= csrf_token() ?>"
                ...
                "columns": [{
                    ...
                    {
                        "data": "is_mail_to_customer"
                    },
                    {
                        "data": "is_mail_to_team"
                    },
                    {
                        "data": "is_notification_to_team"
                    },
                    {
                        "data": "status"
                    },
