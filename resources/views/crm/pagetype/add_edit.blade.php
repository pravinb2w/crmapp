<div class="modal-dialog modal-md modal-right">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form class="form-horizontal modal-body" id="pagetype-form" method="POST" action="{{ route('pagetype.save') }}" autocomplete="off">
                @csrf
                <input type="hidden" name="id" value="{{ $id ?? '' }}">
                <div class="row mb-3">
                    <label for="page" class="col-4 col-form-label">Page <span class="text-danger">*</span></label>
                    <div class="col-8">
