                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-centered w-100 dt-responsive nowrap" id="document-types-datatable">
...
@section('add_on_script')
    ...
    <script>
        $(document).ready(function() {
            ...
            const roletable = $('#document-types-datatable').DataTable({

                "processing": true,
                "serverSide": true,
                "ajax": {
                    "url": "<?= route('document_types.list', $companyCode) ?>",
                    "dataType": "json",
                    "type": "POST",
                    "data": {
                        "_token": "<?= csrf_token() ?>"
