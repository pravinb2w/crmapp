<div class="modal-dialog modal-md modal-right">
    <form id="document-types-form" method="POST" action="{{ route('document_types.save', $companyCode) }}" autocomplete="off" class="modal-content h-100">
        ...
        <div class="modal-body p-3" style="width:400px">
            ...
            <div class="mb-3">
                <label for="document_name" class="col-4 col-form-label">Document Name <span class="text-danger">*</span></label>
                <div>
                    <input type="text" name="document_name" id="document_name" class="form-control" value="{{ $info->document_name ?? '' }}" required>
                </div>
            </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(response.error.length > 0 && response.status == "1" ) {
                            ...
                            ReloadDataTableModal('document-types-datatable');
                        }
                    }            
                });
            }
