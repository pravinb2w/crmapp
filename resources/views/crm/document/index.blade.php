                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Customer Document Approval</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Customers Document Approval </h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
...
@section('add_on_script')
    ...
    <script>
        $(document).ready(function() {
            ...
            const roletable = $('#customer_document_approval-datatable').DataTable({

                "processing": true,
                "serverSide": true,
                "ajax": {
                    "url": "<?= route('customer_document_approval.list', $companyCode) ?>",
                    "dataType": "json",
                    "type": "POST",
                    "data": {
                        "_token": "<?= csrf_token() ?>"
