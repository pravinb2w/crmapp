                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-centered w-100 dt-responsive nowrap" id="permissions-datatable">
...
@section('add_on_script')
    ...
    <script>
        $(document).ready(function() {
            ...
            const roletable = $('#permissions-datatable').DataTable({

                "processing": true,
                "serverSide": true,
                "ajax": {
                    "url": "<?= route('permissions.list', $companyCode) ?>",
                    "dataType": "json",
                    "type": "POST",
                    "data": {
                        "_token": "<?= csrf_token() ?>"
