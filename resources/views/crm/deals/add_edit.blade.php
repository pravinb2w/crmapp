                            ...
                            <div class="col-12 mb-2 product_pane" id="product_pane">
                                ...
                                @endphp
                                    ...
                                    <div id="add-product-tab" class="d-flex w-100 mb-1 calc">
                                        ...
                                        <input type="numer" value="{{ $item->price ?? '' }}" class=" form-control w-20" name="price_{{ $limit }}" id="price" onchange="return get_total({{ $limit }})" placeholder="Price" required>
                                        <input type="numer" value="{{ $item->quantity ?? '' }}" class=" form-control w-10" name="quantity_{{ $limit }}" id="qty" onchange="return get_total({{ $limit }})" placeholder="Qty" value="1">
                                        <input type="numer" value="{{ $item->amount ?? '' }}"  class="form-control w-20" name="amount_{{ $limit }}" id="amount" placeholder="Amount" readonly>
                                    </div>
                                    @php
                                        $limit++;
                                    @endphp
