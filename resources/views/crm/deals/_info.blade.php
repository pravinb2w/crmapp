<div class="row  ">
    ...
    <div class="col-md-6 mb-3">
        <div class="d-flex align-items-center justify-content-end">
            @php
                //print_r( $info->assigned_to );
            @endphp
            @if( $info->status == 0 || $info->status == 1 )
                @if( (Auth::user()->hasAccess('deals', 'is_edit') && ( Auth::id() == $info->assigned_to || $info->assigned_to == null ) ) || superadmin() )
            ...
            @else
                ...
                @endif
            @endif
            @if( ( Auth::user()->hasAccess('deals', 'is_delete') && ( Auth::id() == $info->assigned_to || $info->assigned_to == null ) ) || superadmin() )
            <div class="dropdown">
