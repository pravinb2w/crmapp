            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="header-title mb-0 me-3">
                        My Task
                        <span onclick="change_view_length('sortable-1')" class="ui-icon ui-icon-arrowthick-2-n-s"></span>
                    </h3>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="header-title mb-0 me-3">
                        Closing of the Week 
                        <span onclick="change_view_length('sortable-2')" class="ui-icon ui-icon-arrowthick-2-n-s"></span>
                    </h4>
        ...
        <li id="sortable-3" class="{{ $sortable[1][$key] }} p-1"> 
            <div class="card">
                <div class="card-header">
                    <h3 class="header-title mb-0 me-3">
                        All Task
                        <span onclick="change_view_length('sortable-3')" class="ui-icon ui-icon-arrowthick-2-n-s"></span>
                    </h3>
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="header-title">
                        Planned vs Done 
                        <span onclick="change_view_length('sortable-4')" class="ui-icon ui-icon-arrowthick-2-n-s"></span>
                    </h3>
                    <div class="x-y d-center">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="header-title">Deals Started
                        <span onclick="change_view_length('sortable-5')" class="ui-icon ui-icon-arrowthick-2-n-s"></span>
                    </h3>
                    <div class="x-y d-center">
        ...
        <li id="sortable-7" class="{{ $sortable[1][$key] }} p-1">
            <div class="card">
                <div class="card-header">
                    <h3 class="header-title">
                        Deals Won over time
                        <span onclick="change_view_length('sortable-7')" class="ui-icon ui-icon-arrowthick-2-n-s"></span>
                    </h3>
                    <div class="x-y d-center">
                        <small class="muted">This Year</small>
                        <span class="mdi mdi-drag"></span>
        ...
        <li id="sortable-8" class="{{ $sortable[1][$key] }} p-1">
            <div class="card">
                <div class="card-header">
                    <h3 class="header-title">
                        Deals progress
                        <span onclick="change_view_length('sortable-8')" class="ui-icon ui-icon-arrowthick-2-n-s"></span>
                    </h3>
                    <div class="x-y d-center">
                        <small class="muted">This Year</small>
                        <span class="mdi mdi-drag"></span>
        ...
        <li id="sortable-9" class="{{ $sortable[1][$key] }} p-1">
            <div class="card">
                <div class="card-header">
                    <h3 class="header-title">
                        Deals Conversion
                        <span onclick="change_view_length('sortable-9')" class="ui-icon ui-icon-arrowthick-2-n-s"></span>
                    </h3>
                    <div class="x-y d-center">
                        <small class="muted">This Year</small>
                        <span class="mdi mdi-drag"></span>
