...
class CreateCustomFormsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('custom_forms', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('page_type_id')->comment('from page type');
            $table->foreign('page_type_id')->references('id')->on('page_types')->onDelete('no action');
            $table->string('field_type');
            $table->string('is_mandatory')->default('yes')->comment('yes,no');
