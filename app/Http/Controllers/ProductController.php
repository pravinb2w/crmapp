...
class ProductController extends Controller
{
    ...
    public function add_edit(Request $request)
    {
        ...
        $params = [
            'modal_title' => $modal_title, 'id' => $id ?? '',
            'info' => $info ?? '', 'product_code' => $product_code,
            'from' => $from, 'packages' => $packages
        ];
    ...
    public function save(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            $ins['subscription_id'] = $request->subscription_id;
            ...
            if (isset($id) && !empty($id)) {
                ...
                $page->subscription_id = $request->subscription_id;
